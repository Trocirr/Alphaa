...
async def ban(ctx, userName: discord.User):
	...
	embed=discord.Embed(title="User Banned!", description="<a:Success:468812983074553876> **{0} has been banned by **{1}** successfully!".format(member, ctx.message.author),  color=0xff00f6)
	await client.say(embed=embed)
